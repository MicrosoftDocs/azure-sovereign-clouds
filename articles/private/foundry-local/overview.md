...
:::image type="content" source="media/overview/foundry-local-enabled-azure-arc.svg" alt-text="Diagram of Foundry Local on Azure Local architecture with Arc-managed extension, inference operator and model resources, and app calls to secured inference endpoints." lightbox="media/overview/foundry-local-enabled-azure-arc.svg" border="false":::
